###--- reads config.yml file as to perform some validation---
...
def fetch_config_from_yaml(cfg_path: Optional[Path] = None) -> YAML:
    ...
    raise OSError(f"Din't find config file at path: {cfg_path}")
...
def create_and_validate_config(parsed_config: YAML = None) -> Config:
    ...
    #specify data attribute from strictyaml YAML type.
